...
class Home extends Component {
    ...
    componentWillMount() {
        ...
        xhr.open("GET","http://localhost:8085/" + "movies?status=PUBLISHED", true);
        ...
        xhrReleased.addEventListener("readystatechange", function () {
            ...
            if (this.readyState === 4) {
                ...
                let two = JSON.parse(this.responseText);
                that.setState({
                    releasedMovies: two
                });
            }
        ...
        xhrReleased.open("GET", this.props.baseUrl + "movies?status=RELEASED", true);
        ...
        xhrGenres.addEventListener("readystatechange", function () {
            if (this.readyState === 4) {
                let three = JSON.parse(this.responseText);
                that.setState({
                    genresList: three
                });
            }
        ...
        xhrGenres.open("GET", this.props.baseUrl + "genres", true);
        ...
        xhrArtists.addEventListener("readystatechange", function () {
            if (this.readyState === 4) {
                let four = JSON.parse(this.responseText);
                console.log(four);
                that.setState({
                    artistsList:four
                });
        ...
        xhrArtists.open("GET", this.props.baseUrl + "artists", true);
    ...
    filterApplyHandler = () => {
        ...
        xhrFilter.addEventListener("readystatechange", function () {
            if (this.readyState === 4) {
                let five = JSON.parse(this.responseText);
                that.setState({
                    releasedMovies: five
                });
            }
        ...
        xhrFilter.open("GET", this.props.baseUrl + "movies" + encodeURI(queryString), true);
